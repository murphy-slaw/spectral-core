package net.funkpla.spectral_core.platform.registration;
...
public interface RegistrationProvider<T> {
   ...
   * It is <i>recommended</i> to store the resulting provider in a {@code static final} field to the
   * {@link Factory#INSTANCE factory} to avoid creating multiple providers for the same resource key
   * and mod id.
   *
   ...
   * It is <i>recommended</i> to store the resulted provider in a {@code static final} field to the
   * {@link Factory#INSTANCE factory} to avoid creating multiple providers for the same resource key
   * and mod id.
   *
   ...
   * This class is loaded using {@link ServiceLoader Service Loaders}, and only one should exist per
   * mod loader.
   */
  interface Factory {
